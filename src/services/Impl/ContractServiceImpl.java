...
public class ContractServiceImpl implements ContractService {
    ...
    @Override
    public void display() {
        contractList = (List<Contract>) ReadAndWrite.read("G:\\TrainingJava\\Furama\\src\\data\\contracts.csv");
    ...
    public void addNew() {
        ...
        while (!bookingQueue.isEmpty()) {
            ...
            ReadAndWrite.write(contractList, "G:\\TrainingJava\\Furama\\src\\data\\contracts.csv");
        }
    }
