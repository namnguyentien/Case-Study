...
public class CustomerServiceImpl implements CustomerService {
    ...
    @Override
    public void display() {
        customerList = (List<Customer>) ReadAndWrite.read("G:\\TrainingJava\\Furama\\src\\data\\customers.csv");
        for (Customer customer : customerList) {
    ...
    public void addNew() {
        ...
        ReadAndWrite.write(customerList, "G:\\TrainingJava\\Furama\\src\\data\\customers.csv");
    }
    @Override
    public void edit() {
